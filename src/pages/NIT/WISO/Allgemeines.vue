  ...
  <q-page padding>
    ...
    <ul>
      ...
      <ul>
        ...
        <li>
          Tarifautonomie = Recht Löhne, Gehälter und andere Arbeitsbedingungen
      ...
      <ul>
        <li>
          ...
          Dokumentation von Kompetenzen und dem Vergleich von Qualifikationen
        </li>
        <li>
          Erstellung von Lebenslauf / Erfassen von Details zu Ausbildung und
