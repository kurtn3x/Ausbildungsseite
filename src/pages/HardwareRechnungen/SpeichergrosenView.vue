  ...
  <div class="text-body1" :class="small ? 'q-ma-sm' : 'q-ma-lg'">
    ...
    <ul>
      ...
      <ul>
        ...
        <li>
          generell ist eine Speichergröße immer mit der Byte-Umrechnung zu
          verstehen, es sei denn die Endung endet mit ...bit (Unterschied: 8 Bit
          = 1 Byte)
        </li>
        <li>Beispiel:</li>
        <ul>
      ...
      <table class="tg q-mt-md">
        ...
        <tbody>
          <tr>
            <td class="tg-0lax">2er</td>
            <td class="tg-0lax">100.000.000 Bit</td>
            <td class="tg-0lax">12.500.000 Byte</td>
            <td class="tg-0lax">~12.207 KiB</td>
            <td class="tg-0lax">~11,92 MiB</td>
            <td class="tg-0lax">~11,92 / 1024 GiB</td>
            <td class="tg-0lax">~11.92 / 1024 / 1024 TiB</td>
          </tr>
          <tr>
            <td class="tg-0lax">10er</td>
            <td class="tg-0lax">100.000.000 Bit</td>
            <td class="tg-0lax">12.500.000 Byte</td>
            <td class="tg-0lax">12.500 KB</td>
            <td class="tg-0lax">12,5 MB</td>
            <td class="tg-0lax">12,5 / 1000 GB</td>
            <td class="tg-0lax">12,5 / 1000 / 1000 TB</td>
          </tr>
        </tbody>
      </table>
    </ul>
