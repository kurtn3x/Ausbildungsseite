<template>
  <div class="text-body1 q-ma-lg">
    ...
    <ul>
      <li>
        Zweierpotenztabelle benötigt (diese könnte auch weiter gehen, je nach
        Zahlengröße)
      </li>
    ...
    <ul>
      <li>
        ...
        aufgeht muss man so viele Nullen an die Binärzahl vorne heranschreiben,
        bis die Anzahl der Binärzahlen durch 4 teilbar ist
      </li>
      <li>
      ...
      <q-img
        class="fit"
        :src="src + '/rechnungen/hexbindez.jpg'"
      ...
      <ul>
        <table class="tg">
          <thead>
            <tr>
              <th class="tg-0lax">4er- Binärblock<br /></th>
              <th class="tg-0lax">1100</th>
              <th class="tg-0lax">0101</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td class="tg-0lax">Hexadezimalzahl</td>
              <td class="tg-0lax">C</td>
              <td class="tg-0lax">5</td>
            </tr>
          </tbody>
        </table>
        <li>Diese Binärzahl ergibt die Hexadezimalzahl C5</li>
      </ul>
      <li>
        genau auf dem selben Weg rechnet man auch eine Hexadezimalzahl in eine
        Binärzahl um
      </li>
      <ul>
        <li>
          Man rechnet je eine Hexadezimalzahl in 4Bit um und fügt am Ende die
          Bit zusammen
        </li>
      </ul>
    </ul>
    ...
    <ul>
      <li>
        Ich persönlich rechne Dezimalzahlen immer in Binärzahlen um und beginne
        die Umrechnung wie oben beschrieben von dort.
      </li>
    </ul>
  </div>
</template>
