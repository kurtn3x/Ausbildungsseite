    ...
    <ul>
      ...
      <ul>
        <li>
          ...
          Kupferleitungen (Koaxialkabel, Twisted Pair)
        </li>
        <li>
          <a class="text-weight-bold">Nicht-metallische/optische Leiter:</a>
          Lichtwellenleiter (Multimode Faster, Monomode Faster)
        </li>
        <li class="text-weight-bold">Twisted-Pair</li>
        <ul>
