    ...
    <div :class="small ? 'q-ma-sm' : 'q-ma-lg'">
      ...
      <ul>
        ...
        <ul>
          ...
          <li class="text-weight-bold">
            Directed Broadcast / Network Broadcast
          </li>
          <ul>
            <li>
              Ziel-IP-Adresse: Broadcast-Adresse des Netzes z.B.
              192.168.2.255/24
            </li>
            <li>
              wird vom Router weitergeleitet, falls Quell- und Zielnetz
              unterschiedlich sind und wird erst im Zielnetz zu
              Ethernet-Broadcast umgewandelt
            </li>
            <li>
        ...
        <ul>
          ...
          <li>
            <a class="text-weight-bold">IPv4:</a> untersten 23 Bit der
            IP-Adresse in die MAC-Adresse 01-00-5e-00-00-00 eingesetzt. Dabei
            kann es auch selten zu Überschneidungen kommen.
          </li>
          <li>
