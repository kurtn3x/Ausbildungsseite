      ...
      <ul>
        ...
        <ul>
          ...
          <li>
            ...
            Client mit einem DHCP-Offer, welcher einige wichtige Daten
          ...
          <li>
            ...
            DHCP-Offer Adresse wirklich frei ist. Der DHCP-Request beinhaltet
            eine spezifische Adresse von dem Server, der das DHCP-Offer gestellt
            hat und nur der, der das DHCP-Offer erstellt hat aktzeptiert diese
            Nachricht.
          </li>
          <li>
